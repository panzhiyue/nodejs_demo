...
//获取14天前的时间
console.log(
  "计算前一段时间：" + dayjs().subtract(14, "day").format("YYYY-MM-DD")
);
//获取7天后的时间
console.log("计算后一段时间：" + dayjs().add(7, "day"));
//#region startOf获取一月/一周等 开始时间
console.log(
  "本周第一天开始时间：" + dayjs().startOf("week").format("YYYY-MM-DD")
);
console.log(
  "本月第一天开始时间：" + dayjs().startOf("month").format("YYYY-MM-DD")
);
...
console.log(
  "2020-09-25与2020-06-05相差多少天：" +
    dayjs("2020-09-25").diff("2020-06-05", "day")
);
console.log(
  "2020-09-25与2020-06-05相差多少月：" +
    dayjs("2020-09-25").diff("2020-06-05", "month")
);
console.log(
  "2020-09-25与2020-06-05相差多少小时：" +
    dayjs("2020-09-25").diff("2020-06-05", "hour")
);
//endregion
